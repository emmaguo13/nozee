  ...
  return (
    <>
      ...
      <div className="relative hidden h-full flex-col p-10 text-white sm:flex lg:dark:border-r">
        ...
        <div className="mx-auto mt-20 flex w-full flex-col justify-center space-y-6 sm:w-[800px]">
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-base">
              ...
              you use a JWT obtained from another site, such as ChatGPT, as your
              ...
              verifies the token without compromising any sensitive information
              it contains. By performing this verification, we can confidently
              authenticate your identity. Additionally, the email address
              extracted from the JWT forms the basis for determining your
              company affiliation.
            </p>
